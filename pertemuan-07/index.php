...
session_start();
 ...
 echo $sesname . $sesemail . $sespesan;  
  ...
  $sesnim = $_SESSION["sesNIM"];
    ...
    $sestempat_lahir = $_SESSION["Tempat_lahir"];
    $sestanggal_lahir = $_SESSION["Tanggal_lahir"];
    ...
    <section id="Entry Data Mahasiswa">
      ...
      <form action="proses.php" method="POST">
        ...
        <label for="txtTanggal_lahir"><span>Tanggal Lahir:</span>
          <input type="text" id="txtTanggal_lahir" name="txtTanggal_lahir" placeholder="Masukkan tanggal lahir" required autocomplete="tanggal_lahir">
        </label>
